 ...
 */
@WebServlet({"/Board","/BoardWriteForm","/BoardWrite","/BoardView", "/boardSearch"})
public class BoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/boardSeach":
			...
			String searchTitle = request.getParameter("serchTitle");
			System.out.println("검색어 : " + searchTitle);
			/* SELECT * FROM BOARDS WHERE BSTATE = '1' AND BTILE LIKE '%2023%' */
